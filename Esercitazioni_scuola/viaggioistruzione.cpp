...
int main(){
    ...
    float tothotel, costopullman,totpullman, resto,postosingolo, costotot, costoperpullman;
    ...
    cin>>tothotel;
    cout<<"Di quanto sara' il costo totale dei pullman?"<<endl;
    cin>>totpullman;
    ...
    totpullman = npullman * totpullman;
